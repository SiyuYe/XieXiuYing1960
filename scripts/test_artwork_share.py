...
def main() -> None:
    ...
    require(template, "../artwork-share.js?v=8250", "獨立作品頁未載入分享流程")
    ...
    require(share_js, "share-instagram", "桌機 Instagram 分享輔助未實作")
    require(share_js, "share-wechat", "桌機微信分享輔助未實作")
    ...
    require(share_js, "icon-instagram", "Instagram 分享圖示缺失")
    require(share_js, "icon-wechat", "微信分享圖示缺失")
    ...
    for filename in app_pages:
        ...
        require(page, "artwork-share.js?v=8250", f"{filename} 未載入分享程式")
        require(page, "app.js?v=8250", f"{filename} 未更新 app.js 版本")
