...
function detailList(a) { return [a.artworkTypeName || a.categoryZh, a.subjectNames, a.material].filter(function (v) { return String(v || '').trim(); }); }
...
function infoLines(a) { return [[a.year, a.size].filter(function (v) { return String(v || '').trim(); }).join('｜'), detailList(a).join('｜'), mediumValue(a)].filter(Boolean); }
...
function featuredArtInfoHtml(a) { var titles = titleLines(a), meta = [a.year, a.size].filter(function (v) { return String(v || '').trim(); }).join('｜'), details = detailList(a).join('｜'), medium = mediumValue(a); return "<div class=\"art-info\">".concat(titles.map(function (v, i) { return "".concat(i ? '<span>｜</span>' : '', "<").concat(i ? 'span' : 'strong', ">").concat(esc(v), "</").concat(i ? 'span' : 'strong', ">"); }).join('')).concat(meta ? "<small>".concat(esc(meta), "</small>") : '').concat(details ? "<small class=\"art-details-main\">".concat(esc(details), "</small>") : '').concat(medium ? "<small class=\"art-medium-line\">".concat(esc(medium), "</small>") : '', "</div>"); }
...
function artInfoHtml(a) { var titles = titleLines(a), meta = [a.year, a.size].filter(function (v) { return String(v || '').trim(); }).join('｜'), details = detailList(a).join('｜'), medium = mediumValue(a); return "<div class=\"art-info\">".concat(titles.map(function (v, i) { return "<".concat(i ? 'span' : 'strong', ">").concat(esc(v), "</").concat(i ? 'span' : 'strong', ">"); }).join('')).concat(meta ? "<small>".concat(esc(meta), "</small>") : '').concat(details ? "<small class=\"art-details-main\">".concat(esc(details), "</small>") : '').concat(medium ? "<small class=\"art-medium-line\">".concat(esc(medium), "</small>") : '', "</div>"); }
