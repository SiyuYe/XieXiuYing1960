(function(){
  ...
  function desktop(payload,trigger){
    ...
    box.querySelector('.share-instagram').onclick=function(){copyText(payload.url).then(function(){toast('作品連結已複製，請貼到 Instagram');close();}).catch(function(){toast('無法自動複製，請手動複製網址列');});};
    box.querySelector('.share-wechat').onclick=function(){copyText(payload.url).then(function(){toast('作品連結已複製，請貼到微信');close();}).catch(function(){toast('無法自動複製，請手動複製網址列');});};
