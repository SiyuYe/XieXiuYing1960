(function(){
  ...
  function ensureDialog(){
    ...
    dialog.innerHTML='<section class="artwork-share-panel" role="dialog" aria-modal="true" aria-labelledby="artworkShareTitle"><button type="button" class="artwork-share-close" aria-label="關閉分享選單">×</button><p class="eyebrow">SHARE</p><h2 id="artworkShareTitle">分享這件作品</h2><p class="artwork-share-name"></p><div class="artwork-share-options"><a class="share-option share-facebook" target="_blank" rel="noopener noreferrer">Facebook</a><a class="share-option share-line" target="_blank" rel="noopener noreferrer">LINE</a><a class="share-option share-x" target="_blank" rel="noopener noreferrer">X</a><button type="button" class="share-option share-copy">複製連結</button></div><p class="artwork-share-help">Discord、Threads 或其他平台可先複製連結再貼上。</p></section>';
